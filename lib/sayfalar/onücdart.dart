...
class SayfaBB extends StatefulWidget {
  @override
  _SayfaBState createState() => _SayfaBState();
}

class _SayfaBState extends State<SayfaBB> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(

        title: Text("Sayfa BB AMAÇ SAYFA ÇOĞALTMA"),
      ),
      body: Center(
        ...
        child: Column(
          ...
          children: [
            ...
            RaisedButton(
              child: Text('BURASI SAYFA BB D SAYFASINA GİT'),
              onPressed: () {
